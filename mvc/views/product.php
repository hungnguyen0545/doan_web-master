...
<link rel="stylesheet" href=".././public/css/product.css?v=<?php echo time(); ?>" type="text/css">
</head>
<body>
     <div id="product-panel">
     <?php include_once "template/navbar.php" ?>
     <img src=".././public/css/image-folder/jsss-homepage-desktop.png.imgw.1888.1888.jpeg" alt="panel">
     <div id ="intro-panel">
     <div id="title" >
    ...
    <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion">
      ...
      <div class="slidecontainer">
          ...
          data-filter-val ="co-day DX-125 Genius den chuot">
               <img class="card-img-top bg-light img-product-effect" src=".././public/css/image-folder/chuot/chuot1-1.jpg" alt="Chuột có dây Genius DX-125 Đen">
          ...
          data-filter-val ="co-day M218 Zadez trang chuot">
               <img class="card-img-top bg-light" src=".././public/css/image-folder/chuot/chuot2-1.jpg" alt="Chuột dây rút Zadez M218">
             <div class="card-body card-body-size">
          ...
          data-filter-val ="co-day G610M Zadez den chuot">
               <img class="card-img-top bg-light" src=".././public/css/image-folder/chuot/chuot3-1.jpg" alt="Chuột Gaming Zadez G-610M Đen">
             <div class="card-body card-body-size">
          ...
          <div class="card product-card" >
               <img class="card-img-top bg-light" src=".././public/css/image-folder/chuot/chuot4-1.jpg" alt="Chuột Gaming Zadez GT - 613M">
             <div class="card-body card-body-size">
          ...
          <div class="card product-card" >
               <img class="card-img-top bg-light" src=".././public/css/image-folder/chuot/chuot5-1.jpg" alt="Chuột Gaming Logitech G102 Đen">
             <div class="card-body card-body-size">
          ...
          <div class="card product-card" >
               <img class="card-img-top bg-light" src=".././public/css/image-folder/chuot/chuot6-1.jpg" alt="Chuột không dây Genius NX 7010">
             <div class="card-body card-body-size">
          ...
          <div class="card product-card" >
               <img class="card-img-top bg-light" src=".././public/css/image-folder/chuot/chuot7-1.jpg" alt="Chuột không dây Anitech MW315">
             <div class="card-body card-body-size">
          ...
          <div class="card product-card" >
               <img class="card-img-top bg-light" src=".././public/css/image-folder/chuot/chuot8-1.jpg" alt="Chuột không dây Microsoft 1850">
             <div class="card-body card-body-size">
